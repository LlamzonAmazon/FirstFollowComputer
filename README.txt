...
These sets aid in constructing parsing tables for LL and LR parsers, 
    ensuring that parsers can handle input predictably and resolve ambiguities in parsing strings in the language of the grammar.